...
public class PostThread extends Thread {
    ...
    //首次安装
    public String setInstallData(String utm_source ) {
        MyLogUtils.INSTANCE.d("setInstallData");

        try {
            data = "{\n" +
                    " \"app_id\":\"" + GuiYinSdk.getAppId() + "\",\n" +
                    " \"device_id\": \"" + GuiYinSdk.getDevice_id() + "\",\n" +
...
//            ;
    ...
    //日常启动
    public String setStarData(  String utm_source ) {
...
//                    + "&oaid=" + URLEncoder.encode(oaid, "UTF-8");
    ...
    public String postUrl(int urlType) {
        if (TextUtils.isEmpty(GuiYinSdk.getDevice_id())) {
